...
public class ThirdClient extends Application {
    ...
    public Scene inCorrectPin() {
        int W = WIDTH;
        int H = 300;
        StackPane s = new StackPane();
        Text text = new Text("Incorrect Pin\nTry Again!!!");
        Button button = new Button("Ok");
        button.setStyle("-fx-background-color : red");
        text.setFont(Font.font("VerDana", FontPosture.ITALIC, 20));
        s.getChildren().add(text);
        s.setStyle("-fx-background-color : chartreuse");
